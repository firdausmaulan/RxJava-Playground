...
import kotlinx.android.synthetic.main.creating_observerable.*
import java.util.concurrent.TimeUnit

class CreatingObserverableActivity : AppCompatActivity() {

    private val service = ApiService.create()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.creating_observerable)
        rxCallApi()
    }
